...
const fetchData = async () => {
  try {
    const { data } = await makeRequest({ url: `/user/${storageData.document_number}`, method: 'GET' });
    ...
    birthdateDate.value = dayjs(data.birthdate, dateFormat);
